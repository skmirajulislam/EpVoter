...
def votingPg(root,frame1,client_socket):
    ...
    bjpLogo = ImageTk.PhotoImage((Image.open("/Users/skmirajulislam/Documents/Online-Voting-System/img/bjp.png")).resize((45, 45), Image.LANCZOS))
    ...
    congLogo = ImageTk.PhotoImage((Image.open("/Users/skmirajulislam/Documents/Online-Voting-System/img/cong.jpg")).resize((35, 48), Image.LANCZOS))
    ...
    aapLogo = ImageTk.PhotoImage((Image.open("/Users/skmirajulislam/Documents/Online-Voting-System/img/aap.png")).resize((55, 40), Image.LANCZOS))
    ...
    ssLogo = ImageTk.PhotoImage((Image.open("/Users/skmirajulislam/Documents/Online-Voting-System/img/ss.png")).resize((50, 45), Image.LANCZOS))
    ...
    notaLogo = ImageTk.PhotoImage((Image.open("/Users/skmirajulislam/Documents/Online-Voting-System/img/nota.jpg")).resize((45, 35), Image.LANCZOS))
