...
def showVotes(root, frame1):
    ...
    bjpLogo = ImageTk.PhotoImage((Image.open("/Users/skmirajulislam/Documents/Online-Voting-System/img/bjp.png")).resize((35, 35), Image.LANCZOS))
    bjpImg = Label(frame1, image=bjpLogo).grid(row=2, column=0)

    congLogo = ImageTk.PhotoImage((Image.open("/Users/skmirajulislam/Documents/Online-Voting-System/img/cong.jpg")).resize((25, 38), Image.LANCZOS))
    congImg = Label(frame1, image=congLogo).grid(row=3, column=0)

    aapLogo = ImageTk.PhotoImage((Image.open("/Users/skmirajulislam/Documents/Online-Voting-System/img/aap.png")).resize((45, 30), Image.LANCZOS))
    aapImg = Label(frame1, image=aapLogo).grid(row=4, column=0)

    ssLogo = ImageTk.PhotoImage((Image.open("/Users/skmirajulislam/Documents/Online-Voting-System/img/ss.png")).resize((40, 35), Image.LANCZOS))
    ssImg = Label(frame1, image=ssLogo).grid(row=5, column=0)

    notaLogo = ImageTk.PhotoImage((Image.open("/Users/skmirajulislam/Documents/Online-Voting-System/img/nota.jpg")).resize((35, 25), Image.LANCZOS))
